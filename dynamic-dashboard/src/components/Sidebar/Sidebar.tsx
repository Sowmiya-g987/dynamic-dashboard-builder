...
const chartTypes = [
  { id: "BarChart", label: "Bar Chart", description: "Compare values across categories" },
  { id: "PieChart", label: "Pie Chart", description: "Show proportions and percentages" },
  { id: "LineChart", label: "Line Chart", description: "Display trends over time" },
  { id: "Table", label: "Data Table", description: "View raw data in rows and columns" },
];
