...
const Widget: React.FC<WidgetProps> = ({
  ...
  const hasConfiguration = data.database && data.collection && data.xField && data.yField;
  const displayData = widgetData && widgetData.length > 0 ? widgetData : mockData;
      ...
      >
        ...
        {hasConfiguration && (
          <div style={{ fontSize: "10px", color: "#999", marginTop: "2px" }}>
            ⚙️ Not Configured - Click Edit to Setup
          </div>
        )}
      </div>
        ...
        {hasConfiguration ? (
          ...
          >
            ...
            <div style={{ fontSize: "12px", marginTop: "5px" }}>
              Click Edit to select database and collection
            </div>
          </div>
        ) : loading ? (
          <div
